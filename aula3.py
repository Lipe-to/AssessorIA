...
# dicionario para armazenar o historico de msg
store = {}
# id do usuario -> retorno da função
def get_sesseion_history(session_id) -> ChatMessageHistory:
    # verifica se o usuario nao esta no dic
    if session_id not in store:
        # se nao tiver ele vai criar e guarda a sessão
...
# isso significa para o modelo que o shots é exemplo
...
# =============================================================================
# PROMPT FINAL criando a estrutura do prompt
# Ordem: escolha
# =============================================================================
...
prompt = ChatPromptTemplate.from_messages ([
    ...
    few_shot_prompt,            # shots human/ai
    MessagesPlaceholder("historico"),  # memoria
    ("human", "{usuario}")      # user prompt
])

# estrutura sequencia que o modelo se baseia 
chain_base = prompt | llm | StrOutputParser()

chain = RunnableWithMessageHistory(
    chain_base,
    get_session_history=get_sesseion_history,
